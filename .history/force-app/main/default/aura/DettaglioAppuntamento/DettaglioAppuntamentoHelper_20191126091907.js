({
    ...
    uploadRiepilogo : function(component,event,helper) { 
        var  fotocopieAllegare=component.set('v.fotocopieAllegare');
        var message="message";
	 	var detailEvent = component.get("v.detailEvent");
        let vfUrl = '/apex/RiepilogoAppuntamento?data=' + JSON.stringify(detailEvent)+'&message='+message+'&fotocopieAllegare='+fotocopieAllegare;
