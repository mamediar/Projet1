({
    ...
    uploadRiepilogo : function(component,event,helper) { 
        ...
        var message="message";
	 	var detailEvent = component.get("v.detailEvent");
        let vfUrl = '/apex/RiepilogoAppuntamento?data=' + JSON.stringify(detailEvent)+'&message='+message+'&fotocopieAllegare='+fotocopieAllegare+'&filialeEvent='+JSON.stringify(filialeEvent);
