({
        ...
        action.setCallback(this, function (response) {
            if (response.getState() === "SUCCESS") {
                ...
                if (resultat.erreur===false) {
                    ...
                    this.handleManageContact(component, resultat.resultat[0]);
                }else {
    ...
    queuSelected : function (component, event, helper) {
        ...
        this.handleManageContact(component, qSelected);
    ...
    handleManageContact  : function(component, queueContact) {
        ...
        action.setParams({"grp":queueContact,
                          "pageSize":pageSize,
                          "pageNumber":component.get("v.end+1")}); 
        action.setCallback(this, function (response) {
            if (response.getState() === "SUCCESS") {
                resultat = response.getReturnValue();
                if (!resultat.erreur) {
