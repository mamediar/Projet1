({
    ...
    salvareAppuntamento: function(component) {
      ...
      if (numberNonrisponde < 5 || numberNonrisponde == 5) {
        ...
        //if (hourRichiamare.getHours() + 1 < 16) {
          console.log("getHours ok :>>>", now);
          ...
          //var currentDate = new Date('October 31, 2019 15:00:00');
          //var currentHour = currentDate.getHours();
          var numberHours = 9 + (currentDate.getHours() + 4 - 18);
          //currentDate.setTime(currentDate.getTime() + (numberHours*60*60*1000));
          currentDate.setHours(9 + currentDate.getHours() + 4 - 18);
          var dateAppuntamento = currentDate;
          console.log("aa ok :>>>", numberHours);
          console.log("dateAppuntamento ok :>>>", new Date(currentDate));
          console.log("day Appuntamento ok :>>>", dateAppuntamento.getDay());
        ...
        intervista.COM_Ultimo_Esito__c = "Non risponde";
        intervista.COM_Num_Non_Risponde__c = numberNonrisponde;
        message = "Salvataggio non effettuato, il numero di << Non risponde >> è maggiore di 5";
      }
      ...
      action.setCallback(this, function(response) {
        ...
        if (state === "SUCCESS") {
          ...
          var eventGoIntervista = $A.get("e.c:eventNavigateToIntervistaFuturo");
          eventGoIntervista.setParams({intervistaFuturo: component.get("v.IntervistaIntegrativo")});
    ...
    listQuestions: function(component) {
      ...
      //if (assicurazioneCount == 1 || listOfStringCSERVNotExistCount == 1) {
        ...
        console.log('comodities2 >>', JSON.stringify(comodities));
    ...
    setProcessing: function(component) {
      ...
      intervista.COM_Data_Esito__c = new Date();
      intervista.COM_data_caricamento__c = today.toISOString();
      ...
      action.setCallback(this, function(response) {
        ...
        if (state === "SUCCESS") {
          ...
          this.showToast("Intervista not Processing!", "ERROR");
          console.log(response.getError()[0]);
        }
      });
      $A.enqueueAction(action);
    ...
    redirect: function(component) {
      ...
      //eventToNavigate.setParams({intervistaFuturo: component.get("v.IntervistaIntegrativo")});
