({
    ...
    doInit: function (component,event,helper) {
     ...
     //console.log('limitedIntermediario >> ', limitedIntermediario);
      var dataIntervistaList = component.get("v.dataIntervistaList");
     //console.log('dataIntervistaList >>>', dataIntervistaList);
      ...
      dataIntervistaList = this.filterLimitedIntermediario(limitedIntermediario, dataIntervistaList);
      this.initializePagination(component, dataIntervistaList);
     //console.log('Arrivée initializePagination 2', dataIntervistaList);
    },
    filterLimitedIntermediario: function (limitedIntermediario, dataIntervistaList){
      limitedIntermediario.forEach(function(element){
        dataIntervistaList = dataIntervistaList.filter(
          row => row.Ragione_Sociale_Intermediario__c != element
          );
      });
      return dataIntervistaList;
    },
