({
    ...
    selectedEditRows: function (component, event, helper) {
        var selectedRows = event.getParam('selectedRows');
        let selecteCampaign;
        for (var i = 0; i < selectedRows.length; i++) {
            selecteCampaign = selectedRows[i].Id;
        }
        console.log('Id ' + selecteCampaign);
        component.set("v.SelCamp", selecteCampaign);
        console.log("got the selecteCampaign: " + selecteCampaign);
        var campaignEvent = $A.get("e.c:GUA_ModifiaCampagnaEvent");
        campaignEvent.setParams({
            "updateCampaign": selecteCampaign
        });
        campaignEvent.fire();
    },
})