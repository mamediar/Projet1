({
  ...
  salvareAppuntamento: function(component) {
    ...
    action.setCallback(this, function(response) {
      ...
      if (state === "SUCCESS") {
        ...
        this.showToast("Appuntamento salvati con successo!", "SUCCESS");
        var eventGoIntervista = $A.get("e.c:eventNavigateToIntervista");
    ...
    return [
      ...
      },
      {
        label:
          ...
          " mesi; " +
          "si ricorda che la polizza denominata " +
          TipoConcat +
          " da Lei sottoscritta, " + plurale1Q3 + " una durata pari a " +
          durataSanitarie +
          " mesi?",
        num_question: 3,
        responses: ["Si", "No"],
  ...
  processQuestion1: function(component, responseQuestion) {
    ...
    if (responseQuestion.value == responseSi) {
      ...
      console.log("textLDefinizione avant >> ", textLDefinizione);
      if(textLDefinizione == ''){
        textLDefinizione = this.getAssicurazioneTipoDefizione(
          component
        );
      ...
      console.log("textLDefinizione après >> ", textLDefinizione);
  ...
  processQuestion2: function(component, responseQuestion) {
    ...
    console.log("In processQuestion2");
    var questions = component.get("v.questions");
  ...
  processQuestion3: function(component, responseQuestion) {
    ...
    var questions = component.get("v.questions");
    var responseSi = questions[2].responses[0];
    var responseNo = questions[2].responses[1];
    var newRiposte = component.get("v.newRiposte");
    ...
    /* Archiver l'intervista */
    //component.set("v.intervistaFinita", true);
    console.log("Términer l'Interview, Status à archivé");
  },
  ...
  redirect: function(component) {
    var eventToNavigate = $A.get("e.c:eventNavigateToIntervista");
